...
const ASSETS = [
  ...
  './be-going-to-vs-will-overview.mp3',
  './be-going-to-vs-will-infografica.png',
  './present-perfect-overview.mp3',
  './present-perfect-infografica.png',
  './zero-first-conditional-overview.mp3',
  './zero-first-conditional-infografica.png',
  './question-words.html',
